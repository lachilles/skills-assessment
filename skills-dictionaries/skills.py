...
def without_duplicates(words):
    ...
    # results = [item for item in words if item not in results]
    # couldn't get the "more pythonic" way to work
...
def count_words(phrase):
    ...
    # Bind result to empty dictionary
    # split phrase
    ...
    # for each word in my_string if word is in result, add 1 to the value
    # result[word] = value in the dictionary
